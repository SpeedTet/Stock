...
function fetchTopStocks() {
    // Fetch data from api
    fetch('https://www.alphavantage.co/query?function=SECTOR&apikey=0FQF7E3VFVBJ4EF6').then(response => response.json()).then(data => {
...
function fetchStockData(symbol) {
    ...
    fetch(`https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=0FQF7E3VFVBJ4EF6`).then(response => response.json()).then(data => {
